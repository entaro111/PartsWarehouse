...
namespace PartsWarehouse.Controllers
{
    public class KartotekiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Kartoteki,Nazwa,Stan,Miejsce,Id_JM,Id_Dostawcy")] Kartoteki kartoteki)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Kartoteki,Nazwa,Stan,Miejsce,Id_JM,Id_Dostawcy")] Kartoteki kartoteki)
        {
            if (ModelState.IsValid)
            {
